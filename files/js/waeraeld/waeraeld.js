...
$packages["github.com/Armienn/GoLundin/files/js/waeraeld"] = (function() {
	var $pkg = {}, $init, gocto, js, strconv, Character, Gene, ptrType, sliceType, sliceType$1, funcType, ptrType$1, main, NewGene, addGeneButton, NewButton;
	gocto = $packages["github.com/Nequilich/gocto"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	strconv = $packages["strconv"];
	Character = $pkg.Character = $newType(0, $kindStruct, "main.Character", true, "github.com/Armienn/GoLundin/files/js/waeraeld", true, function(Genes_, Gene_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Genes = sliceType.nil;
			this.Gene = new Gene.ptr("", 0, 0, 0, 0, 0, 0, 0, sliceType$1.nil);
			return;
		}
		this.Genes = Genes_;
		this.Gene = Gene_;
	...
	main = function() {
		...
		character = new Character.ptr(sliceType.nil, new Gene.ptr("", 0, 0, 0, 0, 0, 0, 0, sliceType$1.nil));
		character.Genes = $makeSlice(sliceType, 0);
		genes = new sliceType([NewGene("Endoskelet", 10, 12, 10, 0, 0, 0, 10, new sliceType$1([])), NewGene("Exoskelet", 12, 10, 12, 0, 0, 0, 15, new sliceType$1([])), NewGene("Massivt skelet", 4, 0, 0, 0, 0, 0, 5, new sliceType$1([])), NewGene("Spinkelt skelet", -2, 2, 0, 0, 0, 0, -5, new sliceType$1([])), NewGene("Lunger", 0, 0, 0, 0, 0, 0, 1, new sliceType$1(["Tr\xC3\xA6kke vejret i luft", "Holde vejret", "D\xC3\xB8r uden luft"])), NewGene("Hud", 0, 0, 6, 0, 0, 0, 2, new sliceType$1([]))]);
		destinationElement = $global.otherplace;
		button = NewButton("Clear", (function() {
			var $ptr;
			character.Genes = $makeSlice(sliceType, 0);
			$global.outputText.innerHTML = $externalize(character.GetDescription(), $String);
		}));
	...
	Character.ptr.prototype.UpdateStats = function() {
		var $ptr, _i, _ref, character, gene;
		character = this;
		character.Gene.STR = 0;
		character.Gene.DEX = 0;
		character.Gene.CON = 0;
		character.Gene.INT = 0;
		character.Gene.WIS = 0;
		character.Gene.CHA = 0;
		character.Gene.WeightClass = 0;
		character.Gene.Abilities = new sliceType$1([]);
		_ref = character.Genes;
		_i = 0;
		while (true) {
			if (!(_i < _ref.$length)) { break; }
			gene = ((_i < 0 || _i >= _ref.$length) ? $throwRuntimeError("index out of range") : _ref.$array[_ref.$offset + _i]);
			character.Gene.STR = character.Gene.STR + (gene.STR) >> 0;
			character.Gene.DEX = character.Gene.DEX + (gene.DEX) >> 0;
			character.Gene.CON = character.Gene.CON + (gene.CON) >> 0;
			character.Gene.INT = character.Gene.INT + (gene.INT) >> 0;
			character.Gene.WIS = character.Gene.WIS + (gene.WIS) >> 0;
			character.Gene.CHA = character.Gene.CHA + (gene.CHA) >> 0;
			character.Gene.WeightClass = character.Gene.WeightClass + (gene.WeightClass) >> 0;
			character.Gene.Abilities = $appendSlice(character.Gene.Abilities, gene.Abilities);
			_i++;
		}
	};
	Character.prototype.UpdateStats = function() { return this.$val.UpdateStats(); };
	Character.ptr.prototype.GetDescription = function() {
		var $ptr, _i, _i$1, _ref, _ref$1, ability, character, description, gene;
		character = this;
		character.UpdateStats();
		description = "Abilities:<br/>";
		_ref = character.Gene.Abilities;
		_i = 0;
		while (true) {
			if (!(_i < _ref.$length)) { break; }
			ability = ((_i < 0 || _i >= _ref.$length) ? $throwRuntimeError("index out of range") : _ref.$array[_ref.$offset + _i]);
			description = description + (ability + "<br/>");
			_i++;
		}
		description = description + ("<br/>" + character.Gene.ToString());
		description = description + ("<br/>Genes:<br/>");
		_ref$1 = character.Genes;
		_i$1 = 0;
		while (true) {
			if (!(_i$1 < _ref$1.$length)) { break; }
			gene = ((_i$1 < 0 || _i$1 >= _ref$1.$length) ? $throwRuntimeError("index out of range") : _ref$1.$array[_ref$1.$offset + _i$1]);
			description = description + (gene.Name + "<br/>");
			_i$1++;
		}
		return description;
	};
	...
	addGeneButton = function(character, gene) {
		...
		button = NewButton(gene.Name, (function() {
			var $ptr;
	...
	NewButton = function(text, onClick) {
		...
		button.style.width = $externalize("100%", $String);
		return button;
	};
	...
	ptrType.methods = [{prop: "ToString", name: "ToString", pkg: "", typ: $funcType([], [$String], false)}];
	Character.init("", [{prop: "Genes", name: "Genes", exported: true, typ: sliceType, tag: ""}, {prop: "Gene", name: "", exported: true, typ: Gene, tag: ""}]);
	...
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = gocto.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$synthesizeMethods();
var $mainPkg = $packages["github.com/Armienn/GoLundin/files/js/waeraeld"];
$packages["runtime"].$init();
$go($mainPkg.$init, [], true);
$flushConsole();

}).call(this);
//# sourceMappingURL=waeraeld.js.map
