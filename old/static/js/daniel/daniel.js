...
$packages["github.com/armienn/golundin/files/js/daniel"] = (function() {
	var $pkg = {}, $init, js, main;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	main = function() {
		var $ptr;
		$global.outputText.innerHTML = $externalize("yolo", $String);
	};
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
...
$synthesizeMethods();
var $mainPkg = $packages["github.com/armienn/golundin/files/js/daniel"];
